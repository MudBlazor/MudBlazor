...
public abstract class CommonSnackbarOptions
{
    ...
    /// </remarks>
    public int ShowTransitionDuration { get; set; } = MudGlobal.EnablePreviewFeatures ? 300 : 1000;
    ...
    /// </remarks>
    public int HideTransitionDuration { get; set; } = MudGlobal.EnablePreviewFeatures ? 300 : 2000;
