...
#nullable enable
public readonly record struct StepperClasses(string? StepClass, string? NavClass)
{
    public StepperClasses() : this(null, null) { }
}

public readonly record struct StepperColors(Color CompletedStepColor, Color CurrentStepColor, Color ErrorStepColor)
{
    public StepperColors() : this(Color.Primary, Color.Primary, Color.Error) { }
}

public readonly record struct StepperIcons(string? StepCompleteIcon, string? StepErrorIcon, string? ResetButtonIcon, string? PreviousButtonIcon, string? SkipButtonIcon, string? NextButtonIcon, string? CompleteButtonIcon)
{
