...
namespace MudBlazor
{
    public class BaseMudThemeProvider : ComponentBase
    {
        ...
        protected virtual void GenerateTheme(StringBuilder theme)
        {
            ...
            theme.AppendLine($"--{Typography}-input-family: '{string.Join("','", (Theme.Typography.Input.FontFamily == null ? Theme.Typography.Default.FontFamily : Theme.Typography.Input.FontFamily))}';");
            ...
            theme.AppendLine($"--{Typography}-input-lineheight: {Theme.Typography.Input.LineHeight.ToString(CultureInfo.InvariantCulture)};");
