...
namespace MudBlazor
{
    public class BaseMudThemeProvider : ComponentBase
    {
        ...
        protected virtual void GenerateTheme(StringBuilder theme)
        {
            ...
            theme.AppendLine($"--{Palette}-primary-darken: {Theme.Palette.PrimaryDarken ??= ColorRgbDarken(Theme.Palette.Primary)};");
            theme.AppendLine($"--{Palette}-primary-lighten: {Theme.Palette.PrimaryLighten ??= ColorRgbLighten(Theme.Palette.Primary)};");
            ...
            theme.AppendLine($"--{Palette}-secondary-darken: {Theme.Palette.SecondaryDarken ??= ColorRgbDarken(Theme.Palette.Secondary)};");
            theme.AppendLine($"--{Palette}-secondary-lighten: {Theme.Palette.SecondaryLighten ??= ColorRgbLighten(Theme.Palette.Secondary)};");
            ...
            theme.AppendLine($"--{Palette}-tertiary-darken: {Theme.Palette.TertiaryDarken ??= ColorRgbDarken(Theme.Palette.Tertiary)};");
            theme.AppendLine($"--{Palette}-tertiary-lighten: {Theme.Palette.TertiaryLighten ??= ColorRgbLighten(Theme.Palette.Tertiary)};");
            ...
            theme.AppendLine($"--{Palette}-info-darken: {Theme.Palette.InfoDarken ??= ColorRgbDarken(Theme.Palette.Info)};");
            theme.AppendLine($"--{Palette}-info-lighten: {Theme.Palette.InfoLighten ??= ColorRgbLighten(Theme.Palette.Info)};");
            ...
            theme.AppendLine($"--{Palette}-success-darken: {Theme.Palette.SuccessDarken ??= ColorRgbDarken(Theme.Palette.Success)};");
            theme.AppendLine($"--{Palette}-success-lighten: {Theme.Palette.SuccessLighten ??= ColorRgbLighten(Theme.Palette.Success)};");
            ...
            theme.AppendLine($"--{Palette}-warning-darken: {Theme.Palette.WarningDarken ??= ColorRgbDarken(Theme.Palette.Warning)};");
            theme.AppendLine($"--{Palette}-warning-lighten: {Theme.Palette.WarningLighten ??= ColorRgbLighten(Theme.Palette.Warning)};");
            ...
            theme.AppendLine($"--{Palette}-error-darken: {Theme.Palette.ErrorDarken ??= ColorRgbDarken(Theme.Palette.Error)};");
            theme.AppendLine($"--{Palette}-error-lighten: {Theme.Palette.ErrorLighten ??= ColorRgbLighten(Theme.Palette.Error)};");
            ...
            theme.AppendLine($"--{Palette}-dark-darken: {Theme.Palette.DarkDarken ??= ColorRgbDarken(Theme.Palette.Dark)};");
            theme.AppendLine($"--{Palette}-dark-lighten: {Theme.Palette.DarkLighten ??= ColorRgbLighten(Theme.Palette.Dark)};");
