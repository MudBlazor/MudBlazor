...
namespace MudBlazor
{
    public class BaseMudThemeProvider : ComponentBase
    {
        ...
        protected virtual void GenerateTheme(StringBuilder theme)
        {
            ...
            theme.AppendLine($"--{Palette}-primary-hover: { Theme.Palette.Primary.SetAlpha(Theme.Palette.HoverOpacity).ToRGBA()};");
            ...
            theme.AppendLine($"--{Palette}-secondary-hover: { Theme.Palette.Secondary.SetAlpha(Theme.Palette.HoverOpacity).ToRGBA()};");
            ...
            theme.AppendLine($"--{Palette}-tertiary-hover: { Theme.Palette.Tertiary.SetAlpha(Theme.Palette.HoverOpacity).ToRGBA()};");
            ...
            theme.AppendLine($"--{Palette}-info-hover: { Theme.Palette.Info.SetAlpha(Theme.Palette.HoverOpacity).ToRGBA()};");
            ...
            theme.AppendLine($"--{Palette}-success-hover: { Theme.Palette.Success.SetAlpha(Theme.Palette.HoverOpacity).ToRGBA()};");
            ...
            theme.AppendLine($"--{Palette}-warning-hover: { Theme.Palette.Warning.SetAlpha(Theme.Palette.HoverOpacity).ToRGBA()};");
            ...
            theme.AppendLine($"--{Palette}-error-hover: { Theme.Palette.Error.SetAlpha(Theme.Palette.HoverOpacity).ToRGBA()};");
            ...
            theme.AppendLine($"--{Palette}-dark-hover: { Theme.Palette.Dark.SetAlpha(Theme.Palette.HoverOpacity).ToRGBA()};");
            ...
            theme.AppendLine($"--{Palette}-action-default-hover: { new MudColor(Colors.Shades.Black).SetAlpha(Theme.Palette.HoverOpacity).ToRGBA()};");
