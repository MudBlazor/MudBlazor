...
namespace MudBlazor
{
    public class BaseMudThemeProvider : ComponentBase
    {
        ...
        protected virtual void GenerateTheme(StringBuilder theme)
        {
            ...
            theme.AppendLine($"--{Palette}-primary-rgb: {Theme.Palette.Primary.ToColorRgbElements()};");
            ...
            theme.AppendLine($"--{Palette}-primary-hover: { new MudColor(Theme.Palette.Primary, Theme.Palette.HoverOpacity).ToRGBA()};");
            theme.AppendLine($"--{Palette}-secondary: {Theme.Palette.Secondary};");
            theme.AppendLine($"--{Palette}-secondary-rgb: {Theme.Palette.Secondary.ToColorRgbElements()};");
            ...
            theme.AppendLine($"--{Palette}-secondary-hover: {new MudColor(Theme.Palette.Secondary, Theme.Palette.HoverOpacity).ToRGBA()};");
            theme.AppendLine($"--{Palette}-tertiary: {Theme.Palette.Tertiary};");
            theme.AppendLine($"--{Palette}-tertiary-rgb: {Theme.Palette.Tertiary.ToColorRgbElements()};");
            ...
            theme.AppendLine($"--{Palette}-tertiary-hover: {new MudColor(Theme.Palette.Tertiary, Theme.Palette.HoverOpacity).ToRGBA()};");
            theme.AppendLine($"--{Palette}-info: {Theme.Palette.Info};");
            theme.AppendLine($"--{Palette}-info-rgb: {Theme.Palette.Info.ToColorRgbElements()};");
            ...
            theme.AppendLine($"--{Palette}-info-hover: {new MudColor(Theme.Palette.Info, Theme.Palette.HoverOpacity).ToRGBA()};");
            theme.AppendLine($"--{Palette}-success: {Theme.Palette.Success};");
            theme.AppendLine($"--{Palette}-success-rgb: {Theme.Palette.Success.ToColorRgbElements()};");
            ...
            theme.AppendLine($"--{Palette}-success-hover: {new MudColor(Theme.Palette.Success, Theme.Palette.HoverOpacity).ToRGBA()};");
            theme.AppendLine($"--{Palette}-warning: {Theme.Palette.Warning};");
            theme.AppendLine($"--{Palette}-warning-rgb: {Theme.Palette.Warning.ToColorRgbElements()};");
            ...
            theme.AppendLine($"--{Palette}-warning-hover: {new MudColor(Theme.Palette.Warning, Theme.Palette.HoverOpacity).ToRGBA()};");
            theme.AppendLine($"--{Palette}-error: {Theme.Palette.Error};");
            theme.AppendLine($"--{Palette}-error-rgb: {Theme.Palette.Error.ToColorRgbElements()};");
            ...
            theme.AppendLine($"--{Palette}-error-hover: {new MudColor(Theme.Palette.Error, Theme.Palette.HoverOpacity).ToRGBA()};");
            theme.AppendLine($"--{Palette}-dark: {Theme.Palette.Dark};");
            theme.AppendLine($"--{Palette}-dark-rgb: {Theme.Palette.Dark.ToColorRgbElements()};");
            ...
            theme.AppendLine($"--{Palette}-dark-hover: {new MudColor(Theme.Palette.Dark, Theme.Palette.HoverOpacity).ToRGBA()};");
            ...
            theme.AppendLine($"--{Palette}-action-default-hover: {new MudColor(Colors.Shades.Black, Theme.Palette.HoverOpacity).ToRGBA()};");
