...
public class PopoverOptions
{
    ...
    /// <summary>
    /// Overflow padding for the popover. This is used when adjusting popovers that go off screen at the top or left.
