...
public interface IJsApiService
{
    ...
    /// <summary>
    /// Calls JS method "mudWindow.open". Opens specified url in new tab.
    /// </summary>
    ...
    /// </summary>
    /// <param name="link">A string indicating the URL or path of the resource to be loaded. If an empty string ("") is specified, a blank page is opened into the targeted browsing context.</param>
