...
namespace MudBlazor.UnitTests
{
    ...
    {
        public static Task SetParam<T>(this IRenderedComponentBase<T> self, string name, object? value) where T : IComponent
        {
        ...
        public static Task SetCascadingValue<T>(this IRenderedComponentBase<T> self, string name, object value) where T : IComponent
        {
            return self.SetParametersAndRenderAsync(ComponentParameter.CreateCascadingValue(name, value));
        }
