...
namespace MudBlazor.UnitTests.Other
{
    ...
    public class TypeIdentifierTests
    {
        ...
        public void IsString_(Type type, bool expected)
        {
        ...
        [TestCase(typeof(float?), true)]
        [TestCase(typeof(BigInteger?), true)]
        public void IsNumber_(Type type, bool expected)
        {
        ...
        [TestCase(typeof(Adornment?), true)]
        public void IsEnum_(Type type, bool expected)
        {
        ...
        [TestCase(typeof(DateTime?), true)]
        public void IsDateTime_(Type type, bool expected)
        {
        ...
        [TestCase(typeof(bool?), true)]
        public void IsBoolean_(Type type, bool expected)
        {
        ...
        [TestCase(typeof(DateTime), false)]
        [TestCase(typeof(DateTime?), false)]
        public void IsDateOnly_(Type type, bool expected)
        {
        ...
        [TestCase(typeof(Guid?), true)]
        public void IsGuid_(Type type, bool expected)
        {
