...
namespace MudBlazor.UnitTests.Services
{
    ...
    public class BreakpointListenerServiceTests
    {
        ...
        private async Task CheckSubscriptionOptions(ResizeOptions expectedOptions, bool setBreakpoint)
        {
            ...
            subscriptionResult.SubscriptionId.Should().NotBe(default);
        ...
        {
            BreakpointListenerService.DefaultBreakpointDefinitions.Keys.Should().BeEquivalentTo(
                Breakpoint.Xl, Breakpoint.Lg, Breakpoint.Md, Breakpoint.Sm, Breakpoint.Xs);

            BreakpointListenerService.DefaultBreakpointDefinitions.Values.Should().BeEquivalentTo(
                1920, 1280, 960, 600, 0);
        }
