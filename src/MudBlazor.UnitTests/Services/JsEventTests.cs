...
namespace MudBlazor.UnitTests.Services
{
    ...
    public class JsEventTests
    {
        ...
        public async Task NoSubscriptionWithoutConnectTest()
        {
            ...
            Assert.Throws<InvalidOperationException>(() => jsevent.Paste += static x => Console.WriteLine(x));
            Assert.Throws<InvalidOperationException>(() => jsevent.CaretPositionChanged += static  x => Console.WriteLine(x));
            Assert.Throws<InvalidOperationException>(() => jsevent.Select += static (x, y) => Console.WriteLine());
