...
namespace MudBlazor.UnitTests.Components
{
    ...
    public class SelectTests : BunitTest
    {
        ...
        /// <summary>
        /// A select component with a label should auto-generate an id for the input element and use that id on the label's for attribute.
        /// </summary>
        [Test]
        public void SelectWithLabelShouldBeAccessible()
        {
        ...
        /// <summary>
        /// A select component with a label and an InputId should use the InputId on the input element and the label's for attribute.
        /// </summary>
        [Test]
        public void SelectWithLabelAndInputIdShouldBeAccessible()
        {
        ...
        /// <summary>
        /// A select component with a label and an id in the UserAttributes should use the id on the input element and the label's for attribute.
        /// </summary>
        [Test]
        public void SelectWithLabelAndIdInUserAttributesShouldBeAccessible()
        {
            var expectedId = "test-id";
            var comp = Context.RenderComponent<MudSelect<string>>(parameters
                => parameters
