...
#pragma warning restore BL0005 // Component parameter should not be set outside of its component.
        ...
        public async Task Select_Should_HilightSelectedValue()
        {
            ...
            comp.FindAll("div.mud-list-item")[1].OuterHtml.Should().Contain("mud-selected-item");
        ...
        public void Select_Should_HilightInitiallySelectedValue()
        {
            ...
            comp.WaitForAssertion(() => comp.FindAll("div.mud-selected-item").Count.Should().Be(1));
            comp.FindAll("div.mud-list-item")[0].OuterHtml.Should().Contain("mud-selected-item");
            comp.Find("div.mud-input-control").MouseDown();
            comp.WaitForAssertion(() => comp.Find("div.mud-popover").ClassList.Should().NotContain("mud-popover-open"));
        }
...
#nullable enable
        ...
        public void SelectFitContentTest()
        {
            ...
            //set fit content
            comp.Render(parameters => parameters.Add(c => c.FitContent, true));
            ...
            //set full width
            comp.Render(parameters => parameters.Add(c => c.FullWidth, true));
