...
namespace MudBlazor.UnitTests.Components
{
    ...
    public class SelectTests
    {
        ...
        {
            using var comp = ctx.RenderComponent<SelectTest1>();
        ...
        {
            using var comp = ctx.RenderComponent<MultiSelectTest1>();
            // print the generated html
            Console.WriteLine(comp.Markup);
            // select elements needed for the test
            var select = comp.FindComponent<MudSelect<string>>();
        ...
        {
            using var comp = ctx.RenderComponent<SelectWithEnumTest>();
            Console.WriteLine(comp.Markup);
            // select elements needed for the test
        ...
        {
            using var comp = ctx.RenderComponent<SelectUnrepresentableValueTest>();
            Console.WriteLine(comp.Markup);
            // select elements needed for the test
        ...
        {
            using var comp = ctx.RenderComponent<SelectUnrepresentableValueTest2>();
            Console.WriteLine(comp.Markup);
            // select elements needed for the test
            var select = comp.FindComponent<MudSelect<int>>();
            select.Instance.Value.Should().Be(17);
        ...
        {
            using var comp = ctx.RenderComponent<SelectWithoutItemPresentersTest>();
            Console.WriteLine(comp.Markup);
            // select elements needed for the test
            var select = comp.FindComponent<MudSelect<int>>();
            select.Instance.Value.Should().Be(1);
        ...
        {
            using var comp = ctx.RenderComponent<MultiSelectWithInitialValues>();
            // print the generated html
            Console.WriteLine(comp.Markup);
        ...
        {
            using var comp = ctx.RenderComponent<MultiSelectCustomizedTextTest>();
        ...
        {
            using var comp = ctx.RenderComponent<SelectClearableTest>();
            var select = comp.FindComponent<MudSelect<string>>();
        ...
        {
            using var comp = ctx.RenderComponent<ReselectValueTest>();
            // print the generated html
            Console.WriteLine(comp.Markup);
            // select elements needed for the test
            var select = comp.FindComponent<MudSelect<string>>();
        ...
        {
            using var comp = ctx.RenderComponent<SelectTestEventOrder>();
            var select = comp.FindComponent<MudSelect<string>>();
        ...
        {
            using var comp = ctx.RenderComponent<SelectValidationDataAttrTest>();
            Console.WriteLine(comp.Markup);
        ...
        {
            using var comp = ctx.RenderComponent<SelectRequiredTest>();
