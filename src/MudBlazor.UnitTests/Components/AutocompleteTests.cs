...
namespace MudBlazor.UnitTests.Components
{
    ...
    public class AutocompleteTests : BunitTest
    {
        ...
        public async Task Autocomplete_Should_TolerateNullFromSearchFunc()
        {
            ...
            var setText1 = () => await comp.SetParam(a => a.Text, "Do not throw");
            var setSearchFunc = () => await comp.SetParam(x => x.SearchFunc, new Func<string, CancellationToken, Task<IEnumerable<string>>>((_, _) => null)); // <-- search func returns null instead of task!
            var setText2 = () => await comp.SetParam(a => a.Text, "Don't throw here neither");
