...
namespace MudBlazor.UnitTests.Components
{
    ...
    public class AutocompleteTests
    {
        ...
        {
            using var comp = ctx.RenderComponent<AutocompleteTest1>();
        ...
        {
            using var comp = ctx.RenderComponent<AutocompleteTest2>();
            Console.WriteLine(comp.Markup);
            // select elements needed for the test
        ...
        {
            using var comp = ctx.RenderComponent<AutocompleteTest3>();
            Console.WriteLine(comp.Markup);
        ...
        {
            using var comp = ctx.RenderComponent<AutocompleteTest4>();
            Console.WriteLine(comp.Markup);
        ...
        {
            using var comp = ctx.RenderComponent<MudAutocomplete<string>>((a) =>
            {
        ...
        {
            using var comp = ctx.RenderComponent<AutocompleteTest5>();
            Console.WriteLine(comp.Markup);
        ...
        {
            using var comp = ctx.RenderComponent<AutocompleteSetParametersInitialization>();
            Console.WriteLine(comp.Markup);
            // select elements needed for the test
            await Task.Delay(100);
        ...
        {
            using var comp = ctx.RenderComponent<AutocompleteTestClearable>();
        ...
        {
            using var comp = ctx.RenderComponent<AutocompleteValidationDataAttrTest>();
            Console.WriteLine(comp.Markup);
            var autocompletecomp = comp.FindComponent<MudAutocomplete<string>>();
            var autocomplete = autocompletecomp.Instance;
        ...
        {
            using var comp = ctx.RenderComponent<AutocompleteRequiredTest>();
