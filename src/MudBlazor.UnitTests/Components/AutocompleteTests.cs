...
namespace MudBlazor.UnitTests.Components
{
    ...
    public class AutocompleteTests : BunitTest
    {
        ...
        public void AutocompleteReadOnlyShouldNotHaveClearButton()
        {
            ...
            comp.Render(p => p.Add(x => x.ReadOnly, true)); //no clear button when readonly
        ...
        public async Task Autocomplete_ChangeBoundValue()
        {
            await ImproveChanceOfSuccess(async () =>
            {
                ...
                var autocompleteComponent = comp.FindComponent<MudAutocomplete<string>>();
                var autocomplete = autocompleteComponent.Instance;
                autocompleteComponent.Render(parameters => parameters.Add(p => p.DebounceInterval, 0));
                autocompleteComponent.Render(parameters => parameters.Add(p => p.CoerceText, true));
                ...
                autocompleteComponent.Render(parameters => parameters.Add(p => p.TextUpdateSuppression, false));
                // check initial state
        ...
        public void Autocomplete_Should_ChangeAdornmentIcon()
        {
            ...
            var comp = Context.Render<AutocompleteAdornmentChange>(icon);
            var instance = comp.Instance;

            var markupBefore = comp.Find("svg.mud-icon-root").Children.Select(e => e.OuterHtml).Aggregate("", (a, b) => a + b).Trim();
            ...
            var markupAfter = comp.Find("svg.mud-icon-root").Children.Select(e => e.OuterHtml).Aggregate("", (a, b) => a + b).Trim();
        ...
        public void Autocomplete_Should_NotIndicateLoadingByDefault()
        {
            ...
            comp.WaitForAssertion(() => comp.Find("div.mud-autocomplete").Children.Select(e => e.OuterHtml).Aggregate("", (a, b) => a + b).Should().NotContain("progress-indicator-circular"));
        }
        ...
        public void Autocomplete_Should_IndicateLoadingWithCircularProgressIndicator()
        {
            ...
            comp.WaitForAssertion(() => comp.Find("div.mud-autocomplete").Children.Select(e => e.OuterHtml).Aggregate("", (a, b) => a + b).Should().Contain("progress-indicator-circular"));
            comp.WaitForAssertion(() => comp.Find("div.mud-popover").ClassList.Should().Contain("mud-popover-open"));
        ...
        public void Autocomplete_Should_IndicateLoadingWithCircularProgressIndicatorAndAdornmentAdjustment()
        {
            ...
            comp.WaitForAssertion(() => comp.Find("div.mud-autocomplete").ClassList.Should().NotContain("mud-autocomplete--with-progress"));
            comp.WaitForAssertion(() => comp.Find("div.mud-autocomplete").Children.Select(e => e.OuterHtml).Aggregate("", (a, b) => a + b).Should().NotContain("progress-indicator-circular"));
            comp.WaitForAssertion(() => comp.Find("div.mud-autocomplete").Children.Select(e => e.OuterHtml).Aggregate("", (a, b) => a + b).Should().NotContain("progress-indicator-circular--with-adornment"));
        }
        ...
        public void Autocomplete_Should_IndicateLoadingWithCustomProgressIndicator()
        {
            ...
            // Test show
            comp.WaitForAssertion(() => comp.Find("div.mud-autocomplete").ClassList.Should().Contain("mud-autocomplete--with-progress"));
            comp.WaitForAssertion(() => comp.Find("div.mud-autocomplete").Children.Select(e => e.OuterHtml).Aggregate("", (a, b) => a + b).Should().Contain("Loading..."));

            // Test hide
            comp.WaitForAssertion(() => comp.Find("div.mud-autocomplete").ClassList.Should().NotContain("mud-autocomplete--with-progress"));
            comp.WaitForAssertion(() => comp.Find("div.mud-autocomplete").Children.Select(e => e.OuterHtml).Aggregate("", (a, b) => a + b).Should().NotContain("Loading..."));
        }
        ...
        public void Autocomplete_Should_IndicateLoadingWithProgressIndicatorInsidePopover()
        {
            ...
            // Test show
            comp.WaitForAssertion(() => comp.Find("div.mud-autocomplete").ClassList.Should().Contain("mud-autocomplete--with-progress"));
            comp.WaitForAssertion(() => comp.Find("div.mud-popover").OuterHtml.Should().Contain("Loading..."));

            // Test hide
            comp.WaitForAssertion(() => comp.Find("div.mud-autocomplete").ClassList.Should().NotContain("mud-autocomplete--with-progress"));
            comp.WaitForAssertion(() => comp.Find("div.mud-popover").OuterHtml.Should().NotContain("Loading..."));
        }
        ...
        public async Task Autocomplete_Should_Cancel_Search()
        {
            ...
            first.SetCanceled();
            comp.WaitForAssertion(() => comp.Find("div.mud-popover").OuterHtml.Should().NotContain("Foo"));

            second.SetResult(["Bar"]);
            comp.WaitForAssertion(() => comp.Find("div.mud-popover").OuterHtml.Should().Contain("Bar"));
        }
