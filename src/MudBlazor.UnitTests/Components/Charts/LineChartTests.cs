...
namespace MudBlazor.UnitTests.Charts
{
    public class LineChartTests : BunitTest
    {
        ...
        public void LineChartExampleData(InterpolationOption opt)
        {
            ...
            {
                new ChartSeries() { Name = "Series 1", Data = [90, 79, -72, 69, 62, 62, -55, 65, 70] },
                new ChartSeries() { Name = "Series 2", Data = [10, 41, 35, 51, 49, 62, -69, 91, -148] },
                new ChartSeries() { Name = "Series 3", Data = [10, 41, 35, 51, 49, 62, -69, 91, -148], Visible = false }
            };
        ...
        public void LineChartExampleZeroValues(InterpolationOption opt)
        {
            var chartSeries = new List<ChartSeries>()
            {
                new ChartSeries() { Name = "Series 1", Data = [0, 0, 0, 0, 0, 0, 0, 0, 0] }
            };
            string[] xAxisLabels = ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep"];
        ...
        public void LineChartColoring()
        {
            var chartSeries = new List<ChartSeries>()
            {
                new ChartSeries() { Name = "Deep Sea Blue", Data = [40, 20, 25, 27, 46] },
                new ChartSeries() { Name = "Venetian Red", Data = [19, 24, 35, 13, 28] },
                new ChartSeries() { Name = "Banana Yellow", Data = [8, 6, 11, 13, 4] },
                new ChartSeries() { Name = "La Salle Green", Data = [18, 9, 7, 10, 7] },
                new ChartSeries() { Name = "Rich Carmine", Data = [9, 14, 6, 15, 20] },
                new ChartSeries() { Name = "Shiraz", Data = [9, 4, 11, 5, 19] },
                new ChartSeries() { Name = "Cloud Burst", Data = [14, 9, 20, 16, 6] },
                new ChartSeries() { Name = "Neon Pink", Data = [14, 8, 4, 14, 8] },
                new ChartSeries() { Name = "Ocean", Data = [11, 20, 13, 5, 5] },
                new ChartSeries() { Name = "Orangey Red", Data = [6, 6, 19, 20, 6] },
                new ChartSeries() { Name = "Catalina Blue", Data = [3, 2, 20, 3, 10] },
                new ChartSeries() { Name = "Fountain Blue", Data = [3, 18, 11, 12, 3] },
                new ChartSeries() { Name = "Irish Green", Data = [20, 5, 15, 16, 13] },
                new ChartSeries() { Name = "Wild Strawberry", Data = [15, 9, 12, 12, 1] },
                new ChartSeries() { Name = "Geraldine", Data = [5, 13, 19, 15, 8] },
                new ChartSeries() { Name = "Grey Teal", Data = [12, 16, 20, 16, 17] },
                new ChartSeries() { Name = "Baby Pink", Data = [1, 18, 10, 19, 8] },
                new ChartSeries() { Name = "Thunderbird", Data = [15, 16, 10, 8, 5] },
                new ChartSeries() { Name = "Navy", Data = [16, 2, 3, 5, 5] },
                new ChartSeries() { Name = "Aqua Marina", Data = [17, 6, 11, 19, 6] },
                new ChartSeries() { Name = "Lavender Pinocchio", Data = [1, 11, 4, 18, 1] },
                new ChartSeries() { Name = "Deep Sea Blue", Data = [1, 11, 4, 18, 1] }
            };
