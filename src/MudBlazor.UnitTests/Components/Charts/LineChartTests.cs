    ...
    public class LineChartTests : BunitTest
    {
        ...
        public async Task LineChartExampleData(InterpolationOption opt)
        {
            ...
            if (comp.Instance.CanHideSeries)
            {
                ...
                // Hide Series 1
               await  await comp.InvokeAsync(() => seriesCheckboxes[0].ChangeAsync(false));
                ...
                // Show Series 1 again
               await  await comp.InvokeAsync(() => seriesCheckboxes[0].ChangeAsync(true));
               ...
               await  await comp.InvokeAsync(() => seriesCheckboxes[2].ChangeAsync(true));
                ...
                // Hide Series 3 again
               await  await comp.InvokeAsync(() => seriesCheckboxes[2].ChangeAsync(false));
