...
namespace MudBlazor.UnitTests.Charts
{
    public class StackedBarChartTests : BunitTest
    {
        ...
        public void BarChartExampleData()
        {
            ...
            {
                new () { Label = "United States", Data = new double[] { 40, 20, 25, 27, 46, 60, 48, 80, 15 } },
                new () { Label = "Germany", Data = new double[] { 19, 24, 35, 13, 28, 15, 13, 16, 31 } },
                new () { Label = "Sweden", Data = new double[] { 8, 6, 11, 13, 4, 16, 10, 16, 18 } },
            };
