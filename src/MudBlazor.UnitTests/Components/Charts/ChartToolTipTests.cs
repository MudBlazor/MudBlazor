...
namespace MudBlazor.UnitTests.Charts
{
    public class ChartToolTipTests : BunitTest
    {
        ...
        public void BarChartEmptyData()
        {
            ...
            comp.Markup.Should().Contain("<text x=\"10.05\" y=\"-9.98\" text-anchor=\"middle\" font-size=\"12px\" fill=\"unset\" blazor:elementReference=\"\"><tspan x=\"10.05\" dy=\"0\">Some Title</tspan><tspan x=\"10.05\" dy=\"16\">Some Subtitle</tspan></text>");
        }
    }
}
