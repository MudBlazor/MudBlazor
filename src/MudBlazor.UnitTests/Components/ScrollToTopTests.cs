...
public class ScrollToTopTests : BunitTest
{
    ...
    {
        var (component, listener, _, factory) = RenderTestComponent(parameters => parameters
    ...
    {
        var (_, listener, _, factory) = RenderTestComponent(parameters => parameters
            .Add(x => x.Selector, "   "));
    ...
    {
        var (component, listener, _, _) = RenderTestComponent(parameters => parameters
    ...
    {
        var clicked = false;
        var (component, _, scrollManagerMock, _) = RenderTestComponent(parameters => parameters
            .Add(x => x.Selector, "#target")
    ...
    {
        var (component, listener, _, _) = RenderTestComponent();
    ...
    /// </summary>
    private (IRenderedComponent<MudScrollToTop> Component, FakeScrollListener Listener, Mock<IScrollManager> ScrollManagerMock, FakeScrollListenerFactory Factory) RenderTestComponent(Action<ComponentParameterCollectionBuilder<MudScrollToTop>> configure = null)
    {
    ...
    /// <summary>
    /// Creates the scroll listener test double used by these tests.
    /// </summary>
    ...
    /// <summary>
    /// Tracks subscriptions and allows tests to raise scroll events manually.
    /// </summary>
