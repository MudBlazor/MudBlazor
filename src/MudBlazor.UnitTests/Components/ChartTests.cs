...
namespace MudBlazor.UnitTests.Components
{
    ...
    public class ChartTests : BunitTest
    {
        ...
        public void HeatMap_ShouldGenerateCorrectColorPaletteForDifferentInputs()
        {
            ...
            var singleColorComp = Context.Render<MudChart>(parameters => parameters
                .Add(p => p.ChartType, ChartType.HeatMap)
            ...
            var multiColorComp = Context.Render<MudChart>(parameters => parameters
                .Add(p => p.ChartType, ChartType.HeatMap)
        ...
        public void MudHeatMapCell_ShouldThrowExceptionIfNotInMudChart()
        {
            ...
            var exception = Assert.Throws<InvalidOperationException>(() =>
                Context.Render<MudHeatMapCell>(parameters => parameters
                    .Add(p => p.Row, 0)
                    .Add(p => p.Column, 0)
                )
            );
