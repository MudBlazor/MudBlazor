...
namespace MudBlazor.UnitTests.Components
{
    ...
    public class TimePickerTests : BunitTest
    {
        ...
        public async Task TimePicker_Should_Clear()
        {
            ...
            await comp.SetParam(p => p.Time, new TimeSpan(637940935730000000));
...
#pragma warning disable BL0005 // Component parameter should not be set outside of its component.
            ...
            await comp.SetParam(x => x.Time, new TimeSpan(02, 00, 00));
            ...
            await comp.SetParam(x => x.Time, new TimeSpan(03, 56, 00));
