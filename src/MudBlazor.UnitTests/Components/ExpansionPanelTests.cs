...
namespace MudBlazor.UnitTests.Components
{
    ...
    public class ExpansionPanelTests
    {
        ...
        {
            using var comp = ctx.RenderComponent<ExpansionPanelExpansionsTest>();
        ...
        {
            using var comp = ctx.RenderComponent<ExpansionPanelMultiExpansionTest>();
        ...
        {
            using var comp = ctx.RenderComponent<ExpansionPanelStartExpandedTest>();
        ...
        {
            using var comp = ctx.RenderComponent<ExpansionPanelStartExpandedMultipleTest>();
