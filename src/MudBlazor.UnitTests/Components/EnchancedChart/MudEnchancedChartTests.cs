...
{
    [TestFixture]
    public class MudEnchancedChartTests
    {
        ...
        {
            var comp = ctx.RenderComponent<MudEnchancedChart>();
            ...
            rootElement.ClassList.Should().NotBeEmpty().And.HaveCount(3).And.Contain(new[] { "mud-chart", "d-flex", "flex-column" });
            ...
            titleElement.ClassList.Should().NotBeEmpty().And.HaveCount(4).And.Contain(new[] { "mud-chart-title-container", "d-flex", "justify-center", "order-first" });
            ...
            legendElement.ClassList.Should().NotBeEmpty().And.HaveCount(4).And.Contain(new[] { "mud-chart-legend-container", "d-flex", "order-last", "align-center" });
        }
        ...
        public void Set_Title()
        {
            ...
            var titleContainer = comp.Find(".mud-chart-title-container");
        ...
        public void Set_ShowLegend(Boolean legendShouldBeVisible)
        {
            ...
            {
                var legendContainer = comp.Find(".mud-chart-legend-container");
        ...
        public void Set_ShowTitle(Boolean titleShouldBeVisible)
        {
            ...
            else
            {
                ...
                drawerContainer.ClassList.Should().Contain(new[] { "mud-chart-drawer-container" });
            }
        }
