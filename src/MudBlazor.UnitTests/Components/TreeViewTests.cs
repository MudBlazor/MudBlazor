...
namespace MudBlazor.UnitTests.Components
{
    ...
    public class TreeViewTests : BunitTest
    {
        ...
        public void TreeView_WhenDisabled_DoesNotHaveRipple()
        {
            ...
            comp.Render(parameters => parameters.Add(p => p.Disabled, false));
        ...
        public void TreeView_WhenRippleDisabled_DoesNotHaveRipple()
        {
            ...
            comp.Render(parameters => parameters.Add(p => p.Ripple, true));
            comp.FindAll("div.mud-ripple").Count.Should().BeGreaterThan(0);
        }
        ...
        public void TreeViewItem_DoubleClick_CheckExpanded()
        {
            ...
            item.Render(Parameter(nameof(MudTreeViewItem<string>.OnDoubleClick), new EventCallback<MouseEventArgs>(null, (Action)(() => itemExpanded = !itemExpanded))));
        ...
        public void TreeViewItem_DoubleClick_CheckSelected()
        {
            ...
            tree.Render(Parameter(nameof(MudTreeView<string>.SelectedValueChanged), new EventCallback<string>(null, (Action<string>)((s) => selectedItem = s))));
        ...
        public void TreeView_SetSelectedValue_SetsSelectedValue()
        {
            ...
            comp.Render(parameters => parameters.Add(p => p.SelectedValue, "logo.png"));
        ...
        public void TreeView_SetSelectedValue_IsSetNullWhenNotFound()
        {
            ...
            comp.Render(parameters => parameters.Add(p => p.SelectedValue, "xxxxxx"));
