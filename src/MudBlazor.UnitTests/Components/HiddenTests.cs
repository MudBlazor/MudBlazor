...
namespace MudBlazor.UnitTests.Components
{
    ...
    public class HiddenTests : BunitTest
    {
        ...
        public void SizeChanged()
        {
            ...
            comp.Instance.HiddenChangedHistory.Should().HaveCount(3).And.BeEquivalentTo(false, true, false);
        ...
        public void SizeChangedToNone()
        {
            ...
            comp.Instance.HiddenChangedHistory.Should().ContainSingle().And.BeEquivalentTo(false);
        ...
        public void WithinMudBreakpointProvider_UpdateBreakpointValue()
        {
            ...
            comp.Instance.BreakpointChangedHistory.Should().HaveCount(3).And.BeEquivalentTo(Breakpoint.Md, Breakpoint.Xs, Breakpoint.Sm);
