...
namespace MudBlazor.UnitTests.Utilities
{
    ...
    public class BindingConverterTests
    {
        ...
        public void DefaultConverterTestWithCustomFormat()
        {
            ...
            dt1.Culture = new("en-US");
            dt1.Set(new(2020, 11, 03)).Should().Be("11/03/2020");
            dt1.Get("11/03/2020").Should().Be(new(2020, 11, 03));
            dt1.Culture = new("pt-BR");
            dt1.Format = "dd/MM/yyyy";
            dt1.Set(new(2020, 11, 03)).Should().Be("03/11/2020");
            dt1.Get("03/11/2020").Should().Be(new(2020, 11, 03));

            var dt2 = new DefaultConverter<DateTime?> { Format = "MM/dd/yyyy" };
            dt2.Culture = new("en-US");
        ...
        public void DateTimeConvertersTest()
        {
            ...
            dt1.Culture = new("pt-BR");
            dt1.Set(new(2020, 11, 2)).Should().Be("02/11/2020");
            dt1.Get("02/11/2020").Should().Be(new(2020, 11, 2));
            ...
            dt3.Culture = new("de-AT");
            dt3.Set(new(2020, 11, 2)).Should().Be("02.11.2020");
            dt3.Get("02/11/2020").Should().Be(new(2020, 11, 2));
            var dt4 = new NullableDateConverter("dd/MM/yyyy");
            dt4.Culture = new("de-AT");
