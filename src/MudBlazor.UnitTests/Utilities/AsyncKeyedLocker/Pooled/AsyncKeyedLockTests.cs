...
namespace MudBlazor.UnitTests.Utilities.AsyncKeyedLocker.Pooled
{
    [TestFixture]
    public class AsyncKeyedLockTests
    {
        private readonly AsyncKeyedLocker<string> _keyedLocker = new(o =>
        {
            o.PoolSize = 20;
            o.PoolInitialFill = 1;
        });
        ...
        public class Async : AsyncKeyedLockTests
        {
            [Test]
        ...
        public class Sync : AsyncKeyedLockTests
        {
            [Test]
            [TestCase(100, 100, 10, 100)]
            [TestCase(100, 10, 2, 10)]
        ...
        {
            // Arrange
            var keyedSemaphores = new AsyncKeyedLocker<int>(o =>
            {
                o.PoolSize = 20;
                o.PoolInitialFill = 1;
            });
        ...
        {
            // Arrange
            var dictionary = new AsyncKeyedLocker<string>(o =>
            {
                o.PoolSize = 20;
                o.PoolInitialFill = 1;
            });
