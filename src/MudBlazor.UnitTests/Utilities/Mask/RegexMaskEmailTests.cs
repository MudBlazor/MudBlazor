...
public class RegexMaskEmailTests
{
    ...
    [Test]
    [Arguments("user@example.com", "user@example.com")] //valid
    [Arguments("valid.email@domain.co1", "valid.email@domain.co1")]
    [Arguments("user-123@my-domain.org9", "user-123@my-domain.org9")]
    [Arguments("user_name@domain123.net5", "user_name@domain123.net5")]
    [Arguments("firstname.lastname@sub.domain123.uk", "firstname.lastname@sub.domain123.uk")]
    [Arguments("user.name+alias@sub-domain.example.com", "user.name+alias@sub-domain.example.com")]
    [Arguments("john.doe+9anime-sub@mail-server-2.domain.com", "john.doe+9anime-sub@mail-server-2.domain.com")]
    [Arguments("user@.example.com", "user@example.com")] //invalid
    [Arguments("user@-example.com", "user@example.com")]
    [Arguments("user@example-.com", "user@example-com")]
    [Arguments("user@example..com", "user@example.com")]
    [Arguments("user.@example.com", "user.example.com")]
    [Arguments(".user@mail.domain.com", "user@mail.domain.com")]
    [Arguments("user@sub_domain.example.com", "user@subdomain.example.com")]
