...
public sealed class ApiTextTests : BunitTest
{
    ...
    {
        var comp = Context.Render<ApiText>(Parameter("Text", "Sorry guys, I was drunk when I <see cref wrote these docs, </burp>"));
    ...
    {
        var comp = Context.Render<ApiText>(Parameter("Text", "Gets or sets the icon for this widget."));
    ...
    {
        var comp = Context.Render<ApiText>(Parameter("Text", null));
    ...
    {
        var comp = Context.Render<ApiText>(Parameter("Text", ""));
        comp.Markup.Should().Be("");
    }
    ...
    {
        var comp = Context.Render<ApiText>(Parameter("Text", "For the best Blazor components, go to <see href=\"https://www.mudblazor.com\" /> right now."));
    ...
    {
        var comp = Context.Render<ApiText>(Parameter("Text", "For the best Blazor components, go to <see href=\"https://www.mudblazor.com\">MudBlazor</see> right now."));
        // There should be a text span
        comp.Markup.Should().Contain("<span class=\"mud-typography mud-typography-caption\">For the best Blazor components, go to </span>");
    ...
    {
        var comp = Context.Render<ApiText>(Parameter("Text", "For another Blazor library, go to <see href=\"\" />."));
    ...
    {
        var comp = Context.Render<ApiText>(Parameter("Text", "Occurs when <see cref=\"P:MudBlazor.MudComponentBase.Class\" /> has changed."));
        // There should be a text span
    ...
    {
        var comp = Context.Render<ApiText>(Parameter("Text", "Occurs when <see cref=\"P:MudBlazor.NotExistingType.NotExistingProperty\" /> has changed."));
        // There should be a text span
        comp.Markup.Should().Contain("<span class=\"mud-typography mud-typography-caption\">Occurs when </span>");
    ...
    {
        var comp = Context.Render<ApiText>(Parameter("Text", "When set, calls <see cref=\"M:MudBlazor.AggregateDefinition`1.SimpleAvg\" /> to receive viewport changes."));
        // There should be a text span
    ...
    {
        var comp = Context.Render<ApiText>(Parameter("Text", "When set, calls <see cref=\"M:MudBlazor.NotExistingType.NotExistingMethod\" /> to do stuff."));
        // There should be a text span
        comp.Markup.Should().Contain("<span class=\"mud-typography mud-typography-caption\">When set, calls </span>");
    ...
    {
        var comp = Context.Render<ApiText>(Parameter("Text", "Shows when set to <see cref=\"F:MudBlazor.Adornment.End\" />."));
        // There should be a text span
    ...
    {
        var comp = Context.Render<ApiText>(Parameter("Text", "Shows when set to <see cref=\"F:MudBlazor.Adornment.EndOfTheUniverse\" />."));
        // There should be a text span
        comp.Markup.Should().Contain("<span class=\"mud-typography mud-typography-caption\">Shows when set to </span>");
        // There should be a text span
    ...
    {
        var comp = Context.Render<ApiText>(Parameter("Text", "Gets set when the <see cref=\"E:MudBlazor.MudAlert.OnClick\" /> event occurs."));
        // There should be a text span
    ...
    {
        var comp = Context.Render<ApiText>(Parameter("Text", "Gets set when the <see cref=\"E:MudBlazor.MudAlert.OnSmokeAlarmInYourHouse\" /> event occurs."));
        // There should be a text span
        comp.Markup.Should().Contain("<span class=\"mud-typography mud-typography-caption\">Gets set when the </span>");
        // There should be a text span
    ...
    {
        var comp = Context.Render<ApiText>(Parameter("Text", "The button can contain a <see cref=\"T:Microsoft.AspNetCore.Components.RenderFragment\" />."));
        // There should be a text span
    ...
    {
        var comp = Context.Render<ApiText>(Parameter("Text", "The popover unique ID is a <see cref=\"T:System.Guid\" />."));
        // There should be a text span
