...
namespace MudBlazor.Docs.Services
{
    ...
    public class MenuService : IMenuService
    {
        ...
        private readonly DocsComponents _docsComponents = new DocsComponents()
            ...
            .AddItem("Grid", typeof(MudGrid), new List<Type>() { typeof(MudItem) })
            ...
            .AddItem("Drawer", typeof(MudDrawer), new List<Type>() { typeof(MudDrawerHeader), typeof(MudDrawerContainer) })
            .AddItem("Link", typeof(MudLink))
            .AddItem("Menu", typeof(MudMenu), new List<Type>() { typeof(MudMenuItem)})
            .AddItem("Message Box", typeof(MudMessageBox))
            .AddItem("Nav Menu", typeof(MudNavMenu), new List<Type>() { typeof(MudNavLink), typeof(MudNavGroup) })
            .AddItem("Tabs", typeof(MudTabs), new List<Type>() { typeof(MudTabPanel), typeof(MudDynamicTabs) })
            .AddItem("Progress", typeof(MudProgressCircular), new List<Type>() { typeof(MudProgressLinear) })
            .AddItem("Dialog", typeof(MudDialog), new List<Type>() { typeof(MudDialogInstance), typeof(MudDialogProvider) })
            .AddItem("Snackbar", typeof(MudSnackbarProvider))
            .AddItem("Avatar", typeof(MudAvatar))
            .AddItem("Alert", typeof(MudAlert))
            .AddItem("Card", typeof(MudCard), new List<Type>() { typeof(MudCardActions), typeof(MudCardContent), typeof(MudCardHeader), typeof(MudCardMedia) })
            .AddItem("Divider", typeof(MudDivider))
            .AddItem("Expansion Panel", typeof(MudExpansionPanels), new List<Type>() { typeof(MudExpansionPanel) })
            .AddItem("Icons", typeof(MudIcon))
            .AddItem("List", typeof(MudList), new List<Type>() { typeof(MudListItem), typeof(MudListSubheader) })
            .AddItem("Paper", typeof(MudPaper))
            .AddItem("Rating", typeof(MudRating), new List<Type>() { typeof(MudRatingItem) })
            ...
            .AddItem("TreeView", typeof(MudTreeView<T>), new List<Type>() { typeof(MudTreeViewItem<T>), typeof(MudTreeViewItemToggleButton) })
            .AddItem("Breadcrumbs", typeof(MudBreadcrumbs), new List<Type>() { typeof(BreadcrumbLink), typeof(BreadcrumbSeparator) })
            .AddItem("ScrollToTop", typeof(MudScrollToTop))
            .AddItem("Popover", typeof(MudPopover))
            .AddItem("SwipeArea", typeof(MudSwipeArea))
            .AddItem("ToolBar", typeof(MudToolBar), new List<Type>() { typeof(MudToolBarSpacer) })
            .AddItem("Carousel", typeof(MudCarousel<object>), new List<Type>() { typeof(MudCarouselItem) })

            //GROUPS

            //Inputs
            .AddNavGroup("Form Inputs & controls", false, new DocsComponents()
                .AddItem("Radio", typeof(MudRadio<T>), new List<Type>() { typeof(MudRadioGroup<T>) })
                .AddItem("Checkbox", typeof(MudCheckBox<T>))
                .AddItem("Select", typeof(MudSelect<T>), new List<Type>() { typeof(MudSelectItem<T>) })
