...
public partial class MudComponentDocumenter(Assembly assembly)
{
    ...
    [
        ...
        "MudAlert", "MudAppBar", "MudAutocomplete`1", "MudAvatar", "MudAvatarGroup", "MudBadge", "MudBreadcrumbs",
        "MudBreakpointProvider", "MudButton", "MudButtonGroup", "MudCard", "MudCardActions", "MudCardContent",
        "MudCardHeader", "MudCardMedia", "MudCarousel`1", "MudCarouselItem", "MudChart","MudCheckBox`1", "MudChip`1",
        "MudChipSet`1", "MudCollapse", "MudColor", "MudColorPicker", "MudContainer", "MudDataGrid`1", "MudDataGridPager`1",
        "MudDatePicker", "MudDateRangePicker", "MudDialog", "MudDialogInstance", "MudDialogProvider", "MudDivider",
        "MudDragAndDropIndexChangedEventArgs", "MudDragAndDropItemTransaction`1", "MudDragAndDropTransactionFinishedEventArgs`1",
        "MudDrawer", "MudDrawerContainer", "MudDrawerHeader", "MudDropContainer`1", "MudDropZone`1", "MudDynamicDropItem`1",
        "MudDynamicTabs", "MudElement", "MudExpansionPanel", "MudExpansionPanels", "MudFab", "MudField", "MudFileUpload`1",
        "MudFlexBreak", "MudFocusTrap", "MudForm", "MudGlobal", "MudGrid", "MudHidden", "MudHighlighter", "MudIcon",
        "MudIconButton", "MudImage", "MudInput`1", "MudInputAdornment", "MudInputControl", "MudInputLabel", "MudInputString",
        "MudItem", "MudItemDropInfo`1", "MudLayout", "MudLink", "MudList`1", "MudListItem`1", "MudListSubheader", "MudLocalizer",
        "MudMainContent", "MudMask", "MudMenu", "MudMenuItem", "MudMessageBox", "MudNavGroup", "MudNavLink", "MudNavMenu",
        "MudNumericField`1", "MudOverlay", "MudPageContentNavigation", "MudPageContentSection", "MudPagination", "MudPaper",
        "MudPicker`1", "MudPickerContent", "MudPickerToolbar", "MudPopover", "MudPopoverBase", "MudPopoverHandler",
        "MudPopoverProvider", "MudProgressCircular", "MudProgressLinear", "MudRadio`1", "MudRadioGroup`1", "MudRangeInput`1",
        "MudRating", "MudRatingItem", "MudRender", "MudRTLProvider", "MudScrollToTop", "MudSelect`1",  "MudSelectItem`1",
        "MudSimpleTable", "MudSkeleton", "MudSlider`1", "MudSnackbarProvider", "MudSortableColumn`2", "MudSpacer", "MudSparkLine",
        "MudStack", "MudSwipeArea", "MudSwitch`1", "MudTable`1", "MudTableGroupRow`1", "MudTablePager", "MudTableSortLabel`1",
        "MudTabPanel", "MudTabs", "MudTd", "MudText", "MudTextField`1", "MudTFootRow", "MudTh", "MudTHeadRow", "MudTheme",
        "MudThemeProvider", "MudTimeline", "MudTimelineItem", "MudTimePicker", "MudToggleGroup`1", "MudToggleIconButton",
        "MudToggleItem`1", "MudToolBar", "MudTooltip", "MudTr", "MudTreeView`1", "MudTreeViewItem`1", "MudTreeViewItemToggleButton",
        "MudVirtualize`1",
        // Charts
        "Bar","Donut", "Line", "Pie", "StackedBar", "ChartOptions", "ChartSeries",
        // Common enumerations
        "Adornment", "Align", "Anchor", "ButtonType", "Color", "ColorPickerMode", "ColorPickerView", "Direction", "DrawerClipMode",
        "DrawerVariant", "Edge", "HorizontalAlignment", "InputMode", "InputType", "Justify", "Margin", "MaxWidth", "Orientation",
        "Origin", "PickerVariant", "Placement", "Position", "Severity", "Size", "SkeletonType", "SortDirection", "SortMode",
        "TimelineAlign", "TimelinePosition", "Transition", "Typo", "Variant", "Width", "Wrap",
        // Commonly classes for components
        "TableState", "BreadcrumbItem",
    ];
    ...
    [
        // Object methods
        "ToString", "Equals", "MemberwiseClone", 
        // Blazor component methods
        "OnInitialized", "OnInitializedAsync", "OnParametersSet", "OnParametersSetAsync", "OnAfterRender", "OnAfterRenderAsync", "StateHasChanged", "ShouldRender", "BuildRenderTree", "InvokeAsync",
        // Dispose methods
        "Dispose", "DisposeAsync", "Finalize",
        // Internal MudBlazor methods
        "DispatchExceptionAsync", "CreateRegisterScope", "DetectIllegalRazorParameters"
    ];
