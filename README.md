...
## Prerequisites
- [.NET 7.0](https://dotnet.microsoft.com/en-us/download/dotnet), [.NET 6.0](https://dotnet.microsoft.com/download/dotnet/6.0) for v6.x.x or [.NET 5.0](https://dotnet.microsoft.com/download/dotnet/5.0) for v5.x.x (legacy)
